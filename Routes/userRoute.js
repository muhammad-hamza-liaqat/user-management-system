...
userRoutes.route("/login-user").get(loginPage).post(isthisUser,logUserActivity,userLogin);  // isthisUser middleware attach here
...
userRoutes.route("/change-password").post(checkJWT,logUserActivity,changePassword);
